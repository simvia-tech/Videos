...
Now in order to run an example we are going to extract the case we are interested from the /opt folder
...
in this simulation but if you're displaying the velocity profile you can see with time a nice velocity pattern appearing. It may not appear
